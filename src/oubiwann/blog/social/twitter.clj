(ns oubiwann.blog.social.twitter
...
(defn get-app-consumer-key
  []
  (util/home-file->str "~/.twitter/oubiwann/app-consumer-key"))

(defn get-app-consumer-secret
  []
  (util/home-file->str "~/.twitter/oubiwann/app-consumer-secret"))

(defn get-user-access-token
  []
  (util/home-file->str "~/.twitter/oubiwann/user-access-token"))

(defn get-user-access-token-secret
  []
  (util/home-file->str "~/.twitter/oubiwann/user-access-token-secret"))
